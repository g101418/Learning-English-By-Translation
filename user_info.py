...
@LastEditTime: 2020-07-06 20:26:54
@Description: 
...
class UserInfo(object):
    def __init__(self, user_id):
        ...
        self.user_info_dict = userInfoDb.get_dict(self.__user_id)
    ...
    def __get_max_question_id(self):
        ...
        Returns:
            str: 已做题目最大编号
        """
        all_question_id = self.get_all_question_id()
        max_question_id = str(max(map(lambda x: int(x))))
